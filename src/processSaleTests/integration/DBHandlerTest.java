...
class DBHandlerTest {
    ...
    public void testConstructorAddsItems() {
        ...
        try {
            existantItemDTO = handler.searchInventory("Banana");
    ...
    public void testSearchInventoryReturnsItemDTO() {
        ...
        try {
            item = handler.searchInventory("Banana");
    ...
    public void testSearchInventoryEmptyString() {
        String identifier = "";
        String identifierExpected = "Banana";
        ...
        try {
            ...
            assertTrue(identifierExpected.equals("Banana"), "identifier does not retain initial value 'Banana'.");
    ...
    public void testDatabaseFailureException() {
        ...
        try {
            ...
            assertTrue(identifier.equals("Apple"), "identifier does not retain initial value 'Apple'.");
    ...
    public void testLogSale() {
        ...
        try {
            sale.addItem(new ItemDTO(10, 0.06f, "Banana"), 1);
        }
